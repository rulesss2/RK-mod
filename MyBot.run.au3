...
Func AttackMain() ;Main control for attack functions
	...
	If IsSearchAttackEnabled() Then
		...
		Else
			...
			Setlog("Ожидание войск, героев и / или заклинаний в соответствии с настройками поиска", $COLOR_BLUE)
...
Func Attack() ;Selects which algorithm
	...
	If ( $Android = "BlueStacks" ) Or ( $Android = "BlueStacks2" ) Then
		If $AndroidAdbClicksEnabled Then
	   	...
	   	SetLog( $Android & GetTranslated(55,1,": FastClicks Disabled (Unsuported)"), $COLOR_GREEN)
		EndIf
	EndIf
