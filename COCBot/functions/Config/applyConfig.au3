...
;========================================	
	...
	If $ichkOutSideCollectors = 1 Then
		GUICtrlSetState($chkOutSideCollectors, $GUI_CHECKED)
	Else
		GUICtrlSetState($chkOutSideCollectors, $GUI_UNCHECKED)
	EndIf
	GUICtrlSetData($txtSensCollectors, $itxtSensCollectors)
	GUICtrlSetData($txtPercentCollectors, $stxtPercentCollectors)
	chkOutSideCollectors()

	If $ichkOutSideMines = 1 Then
		GUICtrlSetState($chkOutSideMines, $GUI_CHECKED)
	Else
		GUICtrlSetState($chkOutSideMines, $GUI_UNCHECKED)
	EndIf
	GUICtrlSetData($txtSensMines, $itxtSensMines)
	GUICtrlSetData($txtPercentMines, $stxtPercentMines)
	chkOutSideMines()

	If $ichkOutSideDrills = 1 Then
		GUICtrlSetState($chkOutSideDrills, $GUI_CHECKED)
	Else
		GUICtrlSetState($chkOutSideDrills, $GUI_UNCHECKED)
	EndIf
	GUICtrlSetData($txtSensDrills, $itxtSensDrills)
	GUICtrlSetData($txtPercentDrills, $stxtPercentDrills)
	chkOutSideDrills()
