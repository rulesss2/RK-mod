...
Func StarBonus()
	...
	If $debugSetlog = 1 Then Setlog("Begin Star Bonus window check", $COLOR_DEBUG) ;Debug
	...
	If $debugSetlog = 1 Then Setlog("StarBonusWindowChk #1: " & _GetPixelColor(640, 185 + $midOffsetY, $bCapturePixel) & ", #2: " & _GetPixelColor(650, 462 + $bottomOffsetY, $bCapturePixel), $COLOR_DEBUG) ;Debug
	...
	If _ColorCheck(_GetPixelColor(640, 185 + $midOffsetY, $bCapturePixel), Hex(0xC00F15, 6), 10) And _  ; Check for Red below X for window close
		...
		If $debugSetlog = 1 Then Setlog("Bonus Okay btn chk-#1: " & _GetPixelColor(355, 441 + $midOffsetY, $bCapturePixel) & ", #2: " & _GetPixelColor(355 + 143, 441 + $midOffsetY, $bCapturePixel) & ", #3: " & _GetPixelColor(355 + 53, 441 + 17 + $midOffsetY, $bCapturePixel) & ", #4: " & _GetPixelColor(355 + 53, 441 + 29 + $midOffsetY, $bCapturePixel), $COLOR_DEBUG) ;Debug
		If IsArray($ButtonPixel) Then
			If $debugSetlog = 1 Then
				Setlog("ButtonPixel = " & $ButtonPixel[0] & ", " & $ButtonPixel[1], $COLOR_DEBUG) ;Debug
				Setlog("Bonus Okay Pixel color found #1: " & _GetPixelColor($ButtonPixel[0], $ButtonPixel[1], $bCapturePixel) & ", #2: " & _GetPixelColor($ButtonPixel[0] + 143, $ButtonPixel[1], $bCapturePixel) & ", #3: " & _GetPixelColor($ButtonPixel[0] + 53, $ButtonPixel[1] + 17, $bCapturePixel) & ", #4: " & _GetPixelColor($ButtonPixel[0] + 53, $ButtonPixel[1] + 29, $bCapturePixel), $COLOR_DEBUG) ;Debug
			EndIf
	...
	If $debugSetlog = 1 Then Setlog("Star Bonus window not found?", $COLOR_DEBUG) ;Debug
	Return False
