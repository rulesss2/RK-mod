...
Func AndroidBackButton($bCheckRunState = True)
	...
	If $DebugSetLog = 1 Then Setlog("Used Adb to press back button", $COLOR_DEBUG) ;Debug
	Return True
...
Func AndroidHomeButton()
	...
	If $DebugSetLog = 1 Then Setlog("Used Adb to press home button", $COLOR_DEBUG) ;Debug
	Return True
