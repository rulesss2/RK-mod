...
;~ ------------------------------------------------------
;Local $btnColor = True
;GUICtrlCreatePic(@ScriptDir & "\Images\logo.jpg", 2, 23, 510, 80, $WS_CLIPCHILDREN)
...
$sPng2arrow = @ScriptDir & "\Images\2arrow.png"
$pic2arrow = GUICtrlCreatePic("", $x + 187, $y + 10, 50, 45)
_SetImage($pic2arrow, $sPng2arrow)
