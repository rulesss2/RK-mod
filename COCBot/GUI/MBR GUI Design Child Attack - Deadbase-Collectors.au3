...
$y += 3
		$grpOutCollectors = GUICtrlCreateGroup(GetTranslated(626, 43, "Elixir Collectors"), $x, $y+51, 177, 65)
			...
			$txtPercentCollectors = GUICtrlCreateInput("60%", $x+136, $y+91, 33, 21, BitOR($GUI_SS_DEFAULT_INPUT,$ES_CENTER))
				GUICtrlSetTip(-1, $txtTipOutSide5P1 & GetTranslated(626, 50, " Collectors ") & $txtTipOutSide5P2)
		GUICtrlCreateGroup("", -99, -99, 1, 1)
	$y += 74
		$grpOutMines = GUICtrlCreateGroup(GetTranslated(626, 44, "Gold Mines"), $x, $y+51, 177, 65)
			$chkOutSideMines = GUICtrlCreateCheckbox(GetTranslated(626, 46, "OutSide"), $x+8, $y+67, 63, 17)
				GUICtrlSetTip(-1, $txtTipOutSide1 & GetTranslated(626, 51, " Gold Mines"))
			...
			$txtPercentMines = GUICtrlCreateInput("60%", $x+136, $y+91, 33, 21, BitOR($GUI_SS_DEFAULT_INPUT,$ES_CENTER))
				GUICtrlSetTip(-1, $txtTipOutSide5P1 & GetTranslated(626, 51, " Gold Mines ") & $txtTipOutSide5P2)
		GUICtrlCreateGroup("", -99, -99, 1, 1)
	$y += 74
		$grpOutDrills = GUICtrlCreateGroup(GetTranslated(626, 45, "Dark Elixir Drills"), $x, $y+51, 177, 65)
			$chkOutSideDrills = GUICtrlCreateCheckbox(GetTranslated(626, 46, "OutSide"), $x+8, $y+67, 63, 17)
				GUICtrlSetTip(-1, $txtTipOutSide1 & GetTranslated(626, 52, " Dark Drills"))
			...
			$txtPercentDrills = GUICtrlCreateInput("60%", $x+136, $y+91, 33, 21, BitOR($GUI_SS_DEFAULT_INPUT,$ES_CENTER))
				GUICtrlSetTip(-1, $txtTipOutSide5P1 & GetTranslated(626, 52," Dark Drills ") & $txtTipOutSide5P2)
		GUICtrlCreateGroup("", -99, -99, 1, 1)
