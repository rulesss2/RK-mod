...
; Example .......: No
; ===============================================================================================================================
Global $BackGr, $chkPic, $chkDisableSplash, $chkVersion, $chkDeleteLogs, $chkDeleteTemp, $chkDeleteLoots
...
$hGUI_BOT_TAB_ITEM5 = GUICtrlCreateTabItem(GetTranslated(698,0, "Bot Humanization"))
